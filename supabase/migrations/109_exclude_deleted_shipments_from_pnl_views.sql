-- ============================================
-- MIGRATION: 109_exclude_deleted_shipments_from_pnl_views.sql
-- DESCRIZIONE: Esclude spedizioni cancellate (soft delete) dalle viste finanziarie
-- DATA: 2026-01-16
-- CRITICITÀ: P0 - FIX DATI FINANZIARI
-- ============================================
--
-- PROBLEMA:
-- Le viste finanziarie includono spedizioni cancellate (soft delete)
-- Questo inquina i dati P&L con spedizioni che non dovrebbero essere conteggiate
--
-- SOLUZIONE:
-- Aggiungere filtro s.deleted = false a tutte le 5 viste finanziarie
--
-- NOTA: Le spedizioni cancellate hanno deleted=true e deleted_at IS NOT NULL
...
BEGIN
  ...
  RAISE NOTICE '========================================';
  RAISE NOTICE '✅ Migration 103 completata con successo';
  RAISE NOTICE '';
  RAISE NOTICE '📊 VISTE AGGIORNATE:';
  RAISE NOTICE '   1. v_platform_daily_pnl - Esclude cancellate';
  RAISE NOTICE '   2. v_platform_monthly_pnl - Esclude cancellate';
  RAISE NOTICE '   3. v_reseller_monthly_platform_usage - Esclude cancellate';
  RAISE NOTICE '   4. v_platform_margin_alerts - Esclude cancellate';
  RAISE NOTICE '   5. v_reconciliation_pending - Esclude cancellate';
  RAISE NOTICE '';
  RAISE NOTICE '🔍 VERIFICA:';
  RAISE NOTICE '   Spedizioni cancellate trovate: %', deleted_count;

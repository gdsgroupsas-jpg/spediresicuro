      ...
      <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20 min-h-[80px]">
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <button className="bg-gradient-to-r from-[#FFD700] to-[#FF9500] text-white px-6 py-2 rounded-lg font-semibold hover:shadow-lg transform transition-all duration-200 hover:scale-105">
              Accedi
            </button>
          </div>
        ...
        {isMenuOpen && (
          <div className="md:hidden py-4 border-t border-gray-200">
            <div className="flex flex-col gap-4">
              ...
              <button className="bg-gradient-to-r from-[#FFD700] to-[#FF9500] text-white px-6 py-2 rounded-lg font-semibold mx-4 mt-2">
                Accedi
              </button>
            </div>
          </div>

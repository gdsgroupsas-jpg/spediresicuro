    ...
    <div className="mb-8 overflow-x-hidden">
      ...
      >
        <div className="max-w-full px-4 py-2.5">
          ...
          {/* ⚠️ Quick Links Menu RIMOSSO - La navigazione è disponibile nella sidebar laterale */}
          {/* La barra orizzontale con pulsanti (AI, Super Admin, Admin, Team, ecc.) è stata rimossa */}
          {/* per evitare duplicazione con la sidebar. Usa la sidebar per navigare. */}
        </div>
      </div>

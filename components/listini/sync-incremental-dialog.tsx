...
export function SyncIncrementalDialog({
  ...
  const toggleZone = (zoneCode: string) => {
    setZones((prev) =>
      prev.map((z) => (z.code === zoneCode ? { ...z, selected: !z.selected } : z))
    );
  };
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-3xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            Sincronizza solo le zone mancanti nel listino. Ogni zona viene sincronizzata
            atomicamente (all or nothing).
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="space-y-6">
            ...
            <div className="bg-red-50 border border-red-200 rounded-lg p-4">
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  <h4 className="font-medium text-red-900 mb-1">Metadata Incompleti</h4>
                  ...
                  <p className="text-sm text-red-600">
                    Vai su <strong>&quot;Configurazione&quot;</strong> per completare i metadata del
                    listino.
                  </p>
                </div>
              </div>
          ...
          {!isLoadingZones && zones.length > 0 && (
            <div>
              <div className="flex justify-between items-center mb-3">
                <label className="text-sm font-medium text-gray-700">Zone da Sincronizzare</label>
                ...
                <div className="divide-y">
                  {zones.map((zone) => (
                    ...
                    >
                      ...
                      {zone.isMissing ? (
                        <Badge className="bg-yellow-100 text-yellow-700">Mancante</Badge>
                      ) : (
          ...
          {!isLoadingZones && missingZonesCount === 0 && (
            <div className="text-center py-8 bg-green-50 border border-green-200 rounded-lg">
              ...
              <p className="text-green-700 font-medium">Tutte le zone sono già sincronizzate</p>
            </div>
          )}
          ...
          {syncProgress && (
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
              ...
              <div className="text-sm text-blue-700">
                Zona {syncProgress.current} di {syncProgress.total}: {syncProgress.currentZone}
              </div>
                ...
                {syncResults.map((result, idx) => (
                  ...
                  >
                    ...
                    <div className="text-right">
                      {result.success ? (
                        <div className="text-sm text-green-700">{result.entriesAdded} entries</div>
                      ) : (
                        <div className="text-sm text-red-700">{result.error || 'Errore'}</div>
                      )}
                    </div>
                  </div>
                ))}

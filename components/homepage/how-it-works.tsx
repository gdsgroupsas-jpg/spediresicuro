...
const steps = [
  ...
  },
  {
    ...
    title: 'AI Analizza',
    description:
      'La nostra AI estrae automaticamente tutti i dati: destinatario, indirizzo, CAP, telefono.',
    ...
    <section className="py-24 bg-gradient-to-b from-gray-50 to-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          <h2 className="text-4xl sm:text-5xl font-bold text-gray-900 mb-4">Come Funziona</h2>
            ...
            return (
              <div key={index} className="relative">
                ...
                {index < steps.length - 1 && (
                  <div
                    className="hidden lg:block absolute top-16 left-full w-full h-0.5 bg-gradient-to-r from-gray-200 to-transparent -z-10"
                ...
                <div className="relative bg-white p-8 rounded-2xl border border-gray-100 shadow-lg hover:shadow-xl transition-all duration-300 group">
                  ...
                  {/* Icon */}
                  <div
                    className={`inline-flex p-4 rounded-xl bg-gradient-to-r ${step.color} mb-6 mt-4 group-hover:scale-110 transition-transform duration-300`}
                  >

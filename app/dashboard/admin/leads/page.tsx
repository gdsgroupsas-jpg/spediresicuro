  ...
  return (
    <div className="p-6 max-w-[1600px] mx-auto space-y-6">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          ...
          <p className="text-gray-500 text-sm">
            Gestisci i potenziali clienti e traccia le conversioni.
          </p>
        </div>
      ...
      <div className="flex flex-col md:flex-row gap-4 justify-between bg-white p-4 rounded-xl shadow-sm border border-gray-200">
        ...
        <button
          className="flex items-center gap-2 px-5 py-2 bg-indigo-600 text-white font-medium rounded-lg hover:bg-indigo-700 transition-colors shadow-lg shadow-indigo-200"
          onClick={() => alert('Modale creazione non implementata in questa demo')}
        >

 ...
 *
 * Interfaccia enterprise per:
 * - Visualizzare listini master (template globali)
 * - Clonare listini per reseller/BYOC
...
export default function ListiniMasterPage() {
  ...
  // Load assignments for a price list
                ...
                {filteredLists.length === 0 ? (
                  ...
                  filteredLists.map((list) => (
                    <tr key={list.id} className="hover:bg-gray-50">
                      ...
                      <td className="px-6 py-4">
                        {list.courier?.name || (
                          <span className="text-gray-400">Multi-corriere</span>
                        )}
                      </td>
                      <td className="px-6 py-4">
                        <Badge

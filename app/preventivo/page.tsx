          ...
          >
            <Card glass>
              ...
              <CardContent className="space-y-4">
                ...
                <button className="w-full bg-gradient-to-r from-[#FACC15] to-[#FBBF24] text-[#09090b] px-6 py-3 rounded-lg font-bold btn-tactile flex items-center justify-center gap-2">
                    ...
                    <div className="flex items-start justify-between">
                      ...
                      <div className="text-right">
                        <div className="font-mono-numbers text-2xl font-bold text-gray-100 mb-1">
                          € {corriere.prezzo.toFixed(2).replace('.', ',')}
                        </div>

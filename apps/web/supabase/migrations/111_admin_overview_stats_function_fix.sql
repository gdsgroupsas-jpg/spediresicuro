-- ============================================
-- MIGRATION: 111_admin_overview_stats_function_fix.sql
-- DESCRIPTION: Remove testspediresicuro+ from test email filters
-- DATE: 2026-01-18
-- ============================================
...
Excludes deleted/cancelled by default; when include_test=false excludes test users and tracking numbers (except testspediresicuro+).';

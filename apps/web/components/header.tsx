    ...
    <header className="sticky top-0 z-50 bg-white border-b border-gray-200 shadow-sm">
      <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20 min-h-[80px]">
          ...
          <Link
            href="/"
            className="flex items-center gap-3 hover:opacity-80 transition-opacity py-2 overflow-visible"
          >
            <div className="hidden sm:block h-16 flex items-center overflow-visible">
              <LogoHorizontal className="h-full w-auto max-h-[64px]" width={400} height={133} />
            </div>
            {/* Logo Icon - Mobile */}
            <div className="sm:hidden flex items-center">
              <LogoIcon className="h-12 w-12" width={48} height={48} />
            </div>
          </Link>
          ...
          <div className="hidden md:flex items-center gap-8">
            <Link
              href="/preventivi"
              className="text-gray-700 hover:text-[#FF9500] transition-colors font-medium"
            >
              Preventivi
            </Link>
            <Link

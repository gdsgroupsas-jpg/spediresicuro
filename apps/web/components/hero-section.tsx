...
export default function HeroSection({ variant = 'brand' }: HeroSectionProps) {
  ...
  const variants = {
    brand: {
      ...
      subheadline:
        "Carica uno screenshot. La nostra AI legge, compila, valida tutto. Tu stampi l'etichetta e spedisci. È davvero così semplice.",
    ...
    'energy-professional': {
      ...
      subheadline:
        "Carica uno screenshot. La nostra AI fa il resto. Benvenuto nell'era delle spedizioni intelligenti.",
    ...
    'modern-minimal': {
      ...
      subheadline:
        "Basta screenshot WhatsApp. Il nostro sistema estrae dati, valida indirizzi e crea l'etichetta. Automaticamente.",
  ...
  return (
    <section
      className={`min-h-screen flex items-center bg-[#09090b] py-20 px-4 sm:px-6 lg:px-8 relative grid-beam`}
    >
      <div className="max-w-7xl mx-auto w-full relative z-10">
        <div className="grid lg:grid-cols-5 gap-12 items-center">
          ...
          <div className="lg:col-span-3 space-y-8 relative z-10">
            ...
            <h1
              className={`text-4xl sm:text-5xl lg:text-6xl font-bold leading-tight gradient-animated`}
            >
              {config.headline}
            </h1>
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
              <div
                className={`inline-flex items-center gap-2 px-4 py-2 rounded-full glass border border-[#FACC15]/30 animate-pulse`}
              >
                <svg className={`w-5 h-5 text-[#FACC15]`} fill="currentColor" viewBox="0 0 20 20">
                  <path
                    fillRule="evenodd"
          ...
          <div className="lg:col-span-2 relative z-10">
            ...
            <div className="relative">
              ...
              <div className="relative glass-strong rounded-2xl shadow-2xl p-6 transform transition-all duration-500 hover:scale-105 card-lift">
                ...
                <div className="mb-6 relative">
                  ...
                  <div className="absolute bottom-0 left-1/2 transform -translate-x-1/2 translate-y-1/2">
                    <div
                      className={`bg-gradient-to-br from-[#FACC15] to-[#FBBF24] rounded-full p-3 shadow-lg animate-bounce glow-static`}
                    >
                      <svg
                ...
                {/* Badge AI Processing */}
                <div
                  className={`absolute -top-4 -right-4 bg-gradient-to-br from-[#FACC15] to-[#FBBF24] text-[#09090b] px-4 py-2 rounded-full shadow-lg flex items-center gap-2 animate-pulse glow-static`}
                >
              ...
              {/* Effetto glow */}
              <div
                className={`absolute inset-0 bg-[#FACC15] opacity-10 blur-3xl -z-10 rounded-2xl`}
              ></div>
            </div>
          </div>
        </div>

                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      placeholder="es. MI"
                      maxLength={2}
                      className="w-full px-4 py-2.5 border-2 border-gray-300 rounded-lg bg-white text-gray-900 font-medium placeholder:text-gray-500 hover:border-gray-400 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 focus:shadow-md transition-all uppercase"
                      required
                    />
                  </div>
              ...
              <div className="flex gap-3">
                ...
                <div className="text-sm text-blue-700">
                  ...
                  <ul className="list-disc list-inside space-y-1 text-blue-600">
                    <li>
                      I dati salvati saranno automaticamente precompilati in ogni nuova spedizione
                    </li>

    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-8 space-y-8">
          ...
          <section>
            ...
            <div className="prose prose-sm max-w-none text-gray-700">
              <p>
                ...
                quando visiti un sito web. I cookie permettono al sito di ricordare le tue azioni e
                preferenze per un periodo di tempo, così non devi reinserirle ogni volta che torni
            ...
            <div className="prose prose-sm max-w-none text-gray-700 space-y-6">
              ...
              <div>
                ...
                <p>
                  ...
                  disattivati. Vengono generalmente impostati solo in risposta ad azioni da te
                  effettuate, come l&apos;impostazione delle preferenze di privacy, l&apos;accesso o
              ...
              <div>
                ...
                <div className="bg-gray-50 rounded-lg p-4 mt-3">
                  ...
                  <ul className="list-disc list-inside space-y-1 text-xs text-gray-600 ml-2">
                    <li>
                      <strong>Google Analytics:</strong> Analisi traffico e comportamento utenti
                    </li>
              ...
              <div>
                ...
                <p>
                  Questi cookie vengono utilizzati per tracciare i visitatori attraverso i siti web.
                  L&apos;intento è mostrare annunci rilevanti e coinvolgenti per il singolo utente e
                  quindi più preziosi per editori e inserzionisti di terze parti.
                </p>
                <div className="bg-gray-50 rounded-lg p-4 mt-3">
                  <p className="text-xs font-medium text-gray-700 mb-2">Servizi utilizzati:</p>
                  <ul className="list-disc list-inside space-y-1 text-xs text-gray-600 ml-2">
                    <li>
                      <strong>Facebook Pixel:</strong> Tracciamento conversioni e remarketing
                    </li>
                    <li>
                      <strong>Google Ads:</strong> Pubblicità mirata e remarketing
                    </li>
                    <li>Tracciamento interazioni con annunci</li>
                  </ul>
                </div>
                <p className="text-xs text-gray-600 mt-2">
                  Questi cookie richiedono il tuo consenso esplicito. Puoi gestirli dal banner
                  cookie.
                </p>
              </div>
            </div>
          ...
          <section>
            ...
            <div className="prose prose-sm max-w-none text-gray-700">
              ...
              <ul className="list-disc list-inside space-y-2 ml-4">
                <li>
                  <strong>Cookie di sessione:</strong> Temporanei, vengono eliminati quando chiudi
                  il browser
                </li>
                <li>
                  <strong>Cookie persistenti:</strong> Rimangono sul dispositivo per un periodo
                  definito o fino alla cancellazione manuale
                </li>
              </ul>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-gray-900 mb-4">4. Come Gestire i Cookie</h2>
            <div className="prose prose-sm max-w-none text-gray-700 space-y-4">
              <div>
                <h3 className="text-lg font-medium text-gray-900 mb-2">4.1 Banner Cookie</h3>
                <p>Al primo accesso, vedrai un banner che ti permette di:</p>
                <ul className="list-disc list-inside space-y-2 ml-4">
                ...
                <p className="mt-3">
                  Puoi modificare le tue preferenze in qualsiasi momento cliccando sul banner cookie
                  o visitando questa pagina.
                </p>
              </div>
              <div>
                <h3 className="text-lg font-medium text-gray-900 mb-2">4.2 Impostazioni Browser</h3>
                <p>Puoi anche gestire i cookie direttamente dalle impostazioni del browser:</p>
                <ul className="list-disc list-inside space-y-2 ml-4">
                  <li>
          ...
          <section>
            ...
            <div className="prose prose-sm max-w-none text-gray-700">
              <p>
                Alcuni cookie sono impostati da servizi di terze parti. Questi cookie sono soggetti
          ...
          <section>
            ...
            <div className="prose prose-sm max-w-none text-gray-700">
              <p>
                ...
                modifiche saranno pubblicate su questa pagina. Ti consigliamo di consultare

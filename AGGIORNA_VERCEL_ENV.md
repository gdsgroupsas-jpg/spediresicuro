...
echo "REDACTED_ENCRYPTION_KEY" | npx vercel env add ENCRYPTION_KEY production
echo "REDACTED_ENCRYPTION_KEY" | npx vercel env add ENCRYPTION_KEY preview
echo "REDACTED_ENCRYPTION_KEY" | npx vercel env add ENCRYPTION_KEY development
```

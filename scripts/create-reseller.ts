...
if (!email || !password) {
  console.error('❌ Uso: npx tsx scripts/create-reseller.ts <email> <password> [name] [initialCredit]')
  console.error('')
  console.error('Esempio:')
  console.error('   npx tsx scripts/create-reseller.ts testspediresicuro+01@gmail.com 12345678 "Test Reseller 01" 100')
  process.exit(1)
}

...
if (!supabaseUrl || !supabaseServiceKey) {
  ...
  console.error('');
  console.error('   Oppure usa lo script SQL direttamente in Supabase Dashboard.');
  process.exit(1);
}
...
async function createTestUser() {
  ...
  if (existingUser) {
    console.log('⚠️  Utente testspediresicuro+postaexpress@gmail.com esiste già. Aggiornamento...');
  ...
  console.log('');
  console.log("⚠️  IMPORTANTE: Questo è l'account reseller di produzione per test!");

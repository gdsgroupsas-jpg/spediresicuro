...
export function getFiscalDeadlines() {
  ...
  return [
    { date: `${currentYear}-01-16`, description: 'F24 IVA mensile / Ritenute', type: 'F24' },
    { date: `${currentYear}-02-16`, description: 'F24 IVA mensile / Ritenute', type: 'F24' },
    { date: `${currentYear}-03-16`, description: 'F24 IVA mensile / Ritenute', type: 'F24' },
    { date: `${currentYear}-03-31`, description: 'LIPE Q4 Anno Prec.', type: 'LIPE' },
    { date: `${currentYear}-04-16`, description: 'F24 IVA mensile / Ritenute', type: 'F24' },
    { date: `${currentYear}-04-30`, description: 'Dichiarazione IVA Annuale', type: 'Dichiarazione' },
    { date: `${currentYear}-05-16`, description: 'F24 IVA mensile / Ritenute', type: 'F24' },
    { date: `${currentYear}-05-31`, description: 'LIPE Q1', type: 'LIPE' },
    { date: `${currentYear}-06-16`, description: 'F24 IVA mensile / Ritenute', type: 'F24' },
    { date: `${currentYear}-06-30`, description: 'Saldo Imposte / IRES / IRAP', type: 'Imposte' },
    // ... altri mesi ...
    { date: `${currentYear}-12-16`, description: 'Acconto IVA / F24 Mensile', type: 'F24' },
  ];
}
